...
def activateOptionsPauseScreen(gameScreenState:pygame.Surface):
    optionsPauseScreenActive = True
    ...
    while optionsPauseScreenActive == True & variables.gameIsRunning == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.unicode == "\x1b":
                    optionsPauseScreenActive = False